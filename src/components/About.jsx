            ...
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              ...
              <div className="w-full flex-col justify-center items-start gap-6 flex">
                ...
                <div className="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                  <StatCard title="26+ Awards" description="Our Dedication to Innovation Wins Understanding" />
                  <StatCard title="99% Happy Clients" description="Mirrors our Focus on Client Satisfaction." />
                </div>
              </div>
            </div>
...
// Stateless Component for Statistics Cards
const StatCard = ({ title, description }) => (
  <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">{title}</h4>
